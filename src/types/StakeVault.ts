...
export interface StakeVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface StakeVault extends BaseContract {
  connect(runner?: ContractRunner | null): StakeVault;
  ...
  initialize: TypedContractMethod<
    [more: AddressLike, chainName: string, chainSymbol: string],
    [void],
    "nonpayable"
  >;
