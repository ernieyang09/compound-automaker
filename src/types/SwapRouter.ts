...
export interface SwapRouterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "exactInputFeeOnTransfer",
    values: [ISwapRouter.ExactInputParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "exactInputSingleFeeOnTransfer",
    values: [ISwapRouter.ExactInputSingleParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface SwapRouter extends BaseContract {
  ...
  exactInputFeeOnTransfer: TypedContractMethod<
    [params: ISwapRouter.ExactInputParamsStruct],
    [bigint],
    "payable"
  >;
  ...
  exactInputSingleFeeOnTransfer: TypedContractMethod<
    [params: ISwapRouter.ExactInputSingleParamsStruct],
    [bigint],
    "payable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "exactInputFeeOnTransfer"
  ): TypedContractMethod<
    [params: ISwapRouter.ExactInputParamsStruct],
    [bigint],
    "payable"
  ...
  >;
  getFunction(
    nameOrSignature: "exactInputSingleFeeOnTransfer"
  ): TypedContractMethod<
    [params: ISwapRouter.ExactInputSingleParamsStruct],
    [bigint],
    "payable"
